...
$(package)_patches=remove-libcrypto-dependency.patch add_zlib_library.patch
...
define $(package)_config_cmds
  $($(package)_cmake) -DCMAKE_C_FLAGS="$$($(1)_cflags) -Wl,--build-id=none,-L${HOME}/.guix-profile/lib" -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_SHARED_LINKER_FLAGS="--verbose" ..
endef

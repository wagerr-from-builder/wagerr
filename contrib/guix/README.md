# Bootstrappable Wagerr Core Builds

This directory contains the files necessary to perform bootstrappable Wagerr
Core builds.
...
- 24GB of free disk space on the partition that the Wagerr Core git repository
  resides in
...
For a Wagerr Core depends development environment, simply invoke
...
From the top of a clean Wagerr Core repository:
...
To use dongcarl's substitute server for Wagerr Core builds after having

...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/wagerr/gitian.sigs.git'])
...
def build():
    ...
    os.makedirs('wagerrcore-binaries/' + args.version, exist_ok=True)
    ...
    if args.linux:
        ...
        subprocess.check_call('mv build/out/wagerrcore-*.tar.gz build/out/src/wagerrcore-*.tar.gz ../wagerrcore-binaries/'+args.version, shell=True)
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/wagerrcore-*-win-unsigned.tar.gz inputs/wagerrcore-win-unsigned.tar.gz', shell=True)
        subprocess.check_call('mv build/out/wagerrcore-*.zip build/out/wagerrcore-*.exe ../wagerrcore-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/wagerrcore-*-osx-unsigned.tar.gz inputs/wagerrcore-osx-unsigned.tar.gz', shell=True)
        subprocess.check_call('mv build/out/wagerrcore-*.tar.gz build/out/wagerrcore-*.dmg ../wagerrcore-binaries/'+args.version, shell=True)
...
def sign():
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/wagerrcore-*win64-setup.exe ../wagerrcore-binaries/'+args.version, shell=True)
        subprocess.check_call('mv build/out/wagerrcore-*win32-setup.exe ../wagerrcore-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/wagerrcore-osx-signed.dmg ../wagerrcore-binaries/'+args.version+'/wagerrcore-'+args.version+'-osx.dmg', shell=True)
...
def verify():
    ...
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-linux', '../wagerr/contrib/gitian-descriptors/gitian-linux.yml'])
    print('\nVerifying v'+args.version+' Windows\n')
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-unsigned', '../wagerr/contrib/gitian-descriptors/gitian-win.yml'])
    print('\nVerifying v'+args.version+' MacOS\n')
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-unsigned', '../wagerr/contrib/gitian-descriptors/gitian-osx.yml'])
    print('\nVerifying v'+args.version+' Signed Windows\n')
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-signed', '../wagerr/contrib/gitian-descriptors/gitian-win-signer.yml'])
    print('\nVerifying v'+args.version+' Signed MacOS\n')
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-signed', '../wagerr/contrib/gitian-descriptors/gitian-osx-signer.yml'])

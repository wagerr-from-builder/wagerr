...
def build():
    ...
    if args.macos and not os.path.isfile('inputs/Xcode-12.1-12A7403-extracted-SDK-with-libcxx-headers.tar.gz'):
    	subprocess.check_call(['wget', '-O', 'inputs/Xcode-12.1-12A7403-extracted-SDK-with-libcxx-headers.tar.gz', '-N', '-P', 'inputs', 'https://github.com/wagerr/macosx-sdks/downloads/Xcode-12.1-12A7403-extracted-SDK-with-libcxx-headers.tar.gz'])

    if args.macos and not os.path.isfile('inputs/Xcode-12.1-12A7403-extracted-SDK-with-libcxx-headers.tar.gz'):
    	subprocess.check_call(['wget', '-O', 'inputs/Xcode-12.1-12A7403-extracted-SDK-with-libcxx-headers.tar.gz', '-N', '-P', 'inputs', 'https://github.com/gitianuser/MacOSX-SDKs/releases/download/MacOSX10.11.sdk/Xcode-12.1-12A7403-extracted-SDK-with-libcxx-headers.tar.gz'])

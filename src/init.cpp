...
bool AppInitMain()
{
        ...
        do {
            ...
            try {
                ...
                if (!fDisableGovernance && !fTxIndex
                   && chainparams.NetworkIDString() != CBaseChainParams::REGTEST) { // TODO remove this when pruning is fixed. See https://github.com/wagerr/wagerr/pull/1817 and https://github.com/wagerr/wagerr/pull/1743
    ...
    // ********************************************************* Step 10c: schedule Wagerr-specific tasks

...
/** Utility functions used by the Wagerr Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "wagerr:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load wagerr specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a wagerr specific theme is activated (light/dark).*/

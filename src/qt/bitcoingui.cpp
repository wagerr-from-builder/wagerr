...
void BitcoinGUI::createActions()
{
    ...
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a Wagerr address").arg(strCoinJoinName));
    ...
    openAction->setStatusTip(tr("Open a wagerr: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Wagerr command-line options").arg(PACKAGE_NAME));

...
static void QUARK_HASH(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(BUFFER_SIZE,0);
    while (state.KeepRunning())
...
static void QUARK_HASH_0032b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(32,0);
    while (state.KeepRunning())
...
static void QUARK_HASH_0080b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(80,0);
    while (state.KeepRunning())
...
static void QUARK_HASH_0128b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(128,0);
    while (state.KeepRunning())
...
static void QUARK_HASH_0512b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(512,0);
    while (state.KeepRunning())
...
static void QUARK_HASH_1024b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(1024,0);
    while (state.KeepRunning())
...
static void QUARK_HASH_2048b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(2048,0);
    while (state.KeepRunning())
...
BENCHMARK(QUARK_HASH_0032b_single, 70 * 1000);
BENCHMARK(QUARK_HASH_0080b_single, 65 * 1000);
BENCHMARK(QUARK_HASH_0128b_single, 60 * 1000);
BENCHMARK(QUARK_HASH_0512b_single, 50 * 1000);
BENCHMARK(QUARK_HASH_1024b_single, 50 * 1000);
BENCHMARK(QUARK_HASH_2048b_single, 50 * 1000);
